...
| [Pillow](https://python-pillow.github.io/) | MIT-CMU (HPND) | Reading images for perceptual comparison |
| [pillow-heif](https://github.com/bigcat88/pillow_heif) | BSD-3-Clause (binary wheel: GPLv2, see below) | HEIC/AVIF support (iPhone photos) |
| [openpyxl](https://openpyxl.readthedocs.io/) | MIT | The colour-coded Excel report |
| [et_xmlfile](https://foss.heptapod.net/openpyxl/et_xmlfile) | MIT | openpyxl dependency |

### Libraries inside the pillow-heif binary wheel

The pillow-heif wheel ships prebuilt native libraries. Its own notice states:
...
| x265 | GPL v2 **or later** | <https://bitbucket.org/multicoreware/x265_git> |
| libaom | BSD 3-Clause | <https://aomedia.googlesource.com/aom> |

x265 is "version 2 of the License, or (at your option) any later version",
which is compatible with GPL v3 — so the bundle as a whole is consistent.
(x265 is an *encoder*; this program only ever decodes. Removing it was tested
and does not work: libheif is hard-linked against it at load time — see
[BUILD.md](BUILD.md).)
